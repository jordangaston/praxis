...
const CARDS = [
  {
    ...
    post: 'you',
    body: "Pushes back on vague answers, drills into your reasoning, and scores you the same way a senior engineer would.",
  ...
  },
  {
    ...
    body: 'Sourced from real interview loops — not textbook examples or made-up scenarios. The same questions that got people hired.',
