...
const logos = [
  {
    name: 'Roblox',
    svg: (
      <svg viewBox="0 0 24 24" height="24" fill={FILL}>
  ...
  },
  {
    name: 'Amazon',
    svg: (
      <svg viewBox="0 0 448 512" height="24" fill={FILL}>
  ...
  },
  {
    name: 'Microsoft',
    svg: (
      <svg viewBox="0 0 23 23" height="22" fill={FILL}>
...
export default function Hero() {
  return (
    <section style={{ background: '#ffffff' }}>
      ...
      {/* Logo strip */}
      <div style={{ borderTop: '1px solid #eeeef2', padding: '24px 28px' }}>
        <div
          style={{
            maxWidth: 1200,
            margin: '0 auto',
        ...
        >
          ...
          <svg viewBox="0 0 474.8 110.5" height="22" fill={FILL} style={{ opacity: 1 }}>
